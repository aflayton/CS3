  ...
  */
   ...
   */
	  ...
	  public void removeAnObject(T anObject) throws CannotRemoveException
	  {
		 String paramClass = anObject.getClass().getSimpleName();
         String currClass;
         ...
         for (int i = 0; i < size(); i++)
         {
            ...
            if (currClass.equals(paramClass))
            {
               if (theList.get(i).equals(anObject))
               {
				  /*
	  ...
	  public T retrieveAnObject(T anObject) throws CannotRetrieveException
	  {
		 String paramClass = anObject.getClass().getSimpleName();
         String currClass;
