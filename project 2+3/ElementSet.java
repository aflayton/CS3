  ...
  //package abstractclass;
    ...
    /**
	    ElementSet is a revised version of the PersonSet class. ElementSet
		 illustrates that we can use an array whose base type is an
		 abstract class.  In this case the base type is Element.

 		 Very little in the PersonSet class needed to be changed  because of
		 this.  However, the getCurrent() and add() methods are now much
		 more general since they do not make any assumption about the
		 kinds of objects stored in the ElementSet.
 	*/
   ...
   */
    ...
    */
       ...
       public void add(Element anElement) throws DuplicateObjectException, FullSetException
      {
          // Logic ...
   ...
   */
	  ...
	  public void removeAnObject(Element anObject) throws CannotRemoveException
	  {
         ...
         for (int i = 0; i < currentSize; i++)
         {
            ...
            if (currClass.equals(paramClass))
            {
               ...
               {
				  theList[i] = theList[currentSize];
				  theList[currentSize] = null;
				  currentSize--;
                  return;
               }
            }
